...
pair<vector<Vertex>, vector<uint16>> Mesh::CreateRectangle(float scale)
{
	...
	vec[0].normal = Vector3(0.f, 0.f, -1.f);
	vec[0].tangent = Vector3(1.0f, 0.f, 0.f);
	...
	vec[1].normal = Vector3(0.f, 0.f, -1.f);
	vec[1].tangent = Vector3(1.0f, 0.f, 0.f);
	...
	vec[2].normal = Vector3(0.f, 0.f, -1.f);
	vec[2].tangent = Vector3(1.0f, 0.f, 0.f);
	...
	vec[3].normal = Vector3(0.f, 0.f, -1.f);
	vec[3].tangent = Vector3(1.0f, 0.f, 0.f);
...
pair<vector<Vertex>, vector<uint16>> Mesh::CreateSphere(float scale)
{
	...
	uint32 stackCount = 40; // °¡·Î ºÐÇÒ
	uint32 sliceCount = 40; // ¼¼·Î ºÐÇÒ
...
pair<vector<Vertex>, vector<uint16>> Mesh::CreateGrid(int row, int column, float scale)
{
	...
	for (int j = 0; j < column; ++j)
	{
		...
		for (int i = 0; i < row; ++i)
		{
			...
			v1.normal = v1.pos;
			v1.normal.Normalize();
			v1.normal = Vector3(-1.f, 0.f, 0.f);
			v1.tangent = Vector3(1.f, 0.f, 0.f);
			...
			v2.normal = v2.pos;
			v2.normal.Normalize();
			v2.normal = Vector3(-1.f, 0.f, 0.f);
			v2.tangent = Vector3(1.f, 0.f, 0.f);
			...
			v3.normal = v3.pos;
			v3.normal.Normalize();
			v3.normal = Vector3(-1.f, 0.f, 0.f);
			v3.tangent = Vector3(1.f, 0.f, 0.f);
			...
			v4.normal = v4.pos;
			v4.normal.Normalize();
			v4.normal = Vector3(-1.f, 0.f, 0.f);
			v4.tangent = Vector3(1.f, 0.f, 0.f);
